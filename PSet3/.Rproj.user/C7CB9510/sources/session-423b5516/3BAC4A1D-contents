...
carpetas <- list.files(path = "C:/Users/juanf/OneDrive - Universidad de los Andes/Octavo/Taller R/PSet-3/ProblemSet-3",
                       recursive = T, pattern = "rds")

setwd("C:/Users/juanf/OneDrive - Universidad de los Andes/Octavo/Taller R/PSet-3/ProblemSet-3")
